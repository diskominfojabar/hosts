...
FILE_DROP_IP = 'drop.txt'
FILE_PASS_IP = 'pass.txt'
FILE_WHITELIST_DOMAIN = 'whitelist-domain.txt'
FILE_BLACKLIST_DOMAIN = 'blacklist-domain.txt'
...
def save_to_file(filename, data_set, header_info=""):
    ...
    try:
        with open(filename, 'w') as f:
            f.write(f"; {filename} - Updated at {timestamp}\n")
